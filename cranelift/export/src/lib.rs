...
#[no_mangle]
pub extern "C" fn cranelift_ins_fallthrough(
    ptr: *mut FunctionData,
    block: BlockCode,
    count: u32,
    args: *mut ValueCode,
    ...
    return inst
        .builder
        .ins()
        .fallthrough(Block::from_u32(block), argsdata.as_mut_slice())
        .as_u32();
}
...
#[no_mangle]
pub extern "C" fn cranelift_ins_indirect_jump_table_br(
    ptr: *mut FunctionData,
    x: ValueCode,
    jt: JumpTableCode,
) -> InstCode {
    ...
    return inst
        .builder
        .ins()
        .indirect_jump_table_br(Value::from_u32(x), JumpTable::from_u32(jt))
        .as_u32();
}
...
#[no_mangle]
pub extern "C" fn cranelift_load_complex(
    ptr: *mut FunctionData,
    mem: Type,
    memflags: MemFlagCode,
    count: u32,
...
#[no_mangle]
pub extern "C" fn cranelift_store_complex(
    ptr: *mut FunctionData,
    memflags: MemFlagCode,
    x: ValueCode,
    count: u32,
...
#[no_mangle]
pub extern "C" fn cranelift_uload8_complex(
    ptr: *mut FunctionData,
    iext8: Type,
    memflags: MemFlagCode,
    count: u32,
...
#[no_mangle]
pub extern "C" fn cranelift_sload8_complex(
    ptr: *mut FunctionData,
    iext8: Type,
    memflags: MemFlagCode,
    count: u32,
...
#[no_mangle]
pub extern "C" fn cranelift_istore8_complex(
    ptr: *mut FunctionData,
    memflags: MemFlagCode,
    x: ValueCode,
    count: u32,
...
#[no_mangle]
pub extern "C" fn cranelift_uload16_complex(
    ptr: *mut FunctionData,
    iext16: Type,
    memflags: MemFlagCode,
    count: u32,
...
#[no_mangle]
pub extern "C" fn cranelift_sload16_complex(
    ptr: *mut FunctionData,
    iext16: Type,
    memflags: MemFlagCode,
    count: u32,
...
#[no_mangle]
pub extern "C" fn cranelift_istore16_complex(
    ptr: *mut FunctionData,
    memflags: MemFlagCode,
    x: ValueCode,
    count: u32,
...
#[no_mangle]
pub extern "C" fn cranelift_uload32_complex(
    ptr: *mut FunctionData,
    memflags: MemFlagCode,
    count: u32,
    args: *mut ValueCode,
    ...
    return inst
        .builder
        .ins()
        .uload32_complex(convert_memflags(memflags), &argsdata, offset)
        .as_u32();
}
...
#[no_mangle]
pub extern "C" fn cranelift_sload32_complex(
    ptr: *mut FunctionData,
    memflags: MemFlagCode,
    count: u32,
    args: *mut ValueCode,
    ...
    return inst
        .builder
        .ins()
        .sload32_complex(convert_memflags(memflags), &argsdata, offset)
        .as_u32();
}
...
#[no_mangle]
pub extern "C" fn cranelift_istore32_complex(
    ptr: *mut FunctionData,
    memflags: MemFlagCode,
    x: ValueCode,
    count: u32,
...
#[no_mangle]
pub extern "C" fn cranelift_regmove(
    ptr: *mut FunctionData,
    x: ValueCode,
    src: RegUnit,
    dst: RegUnit,
    ...
    return inst
        .builder
        .ins()
        .regmove(Value::from_u32(x), src, dst)
        .as_u32();
}

#[no_mangle]
pub extern "C" fn cranelift_copy_special(
    ptr: *mut FunctionData,
    src: RegUnit,
    dst: RegUnit,
) -> InstCode {
...
#[no_mangle]
pub extern "C" fn cranelift_copy_to_ssa(
    ptr: *mut FunctionData,
    any: Type,
    src: RegUnit,
) -> ValueCode {
    ...
    return inst
        .builder
        .ins()
        .copy_to_ssa(convert_type(any), src)
        .as_u32();
}
...
pub extern "C" fn cranelift_adjust_sp_down(ptr: *mut FunctionData, delta: ValueCode) -> InstCode {
    ...
    return inst
        .builder
        .ins()
        .adjust_sp_down(Value::from_u32(delta))
        .as_u32();
}
...
#[no_mangle]
pub extern "C" fn cranelift_adjust_sp_down_imm(
    ptr: *mut FunctionData,
    offset: Offset64,
) -> InstCode {
    let inst = unsafe {
...
#[no_mangle]
pub extern "C" fn cranelift_regspill(
    ptr: *mut FunctionData,
    x: ValueCode,
    src: RegUnit,
    ss: StackSlotCode,
    ...
    return inst
        .builder
        .ins()
        .regspill(Value::from_u32(x), src, StackSlot::from_u32(ss))
        .as_u32();
}

#[no_mangle]
pub extern "C" fn cranelift_regfill(
    ptr: *mut FunctionData,
    x: ValueCode,
    ss: StackSlotCode,
    dst: RegUnit,
    ...
    return inst
        .builder
        .ins()
        .regfill(Value::from_u32(x), StackSlot::from_u32(ss), dst)
        .as_u32();
}

#[no_mangle]
pub extern "C" fn cranelift_safepoint(
    ptr: *mut FunctionData,
    count: u32,
    args: *mut ValueCode,
) -> InstCode {
...
#[no_mangle]
pub extern "C" fn cranelift_x86_udivmodx(
    ptr: *mut FunctionData,
    nlo: ValueCode,
    nhi: ValueCode,
    d: ValueCode,
    ...
    let (tmp1, tmp2) = inst.builder.ins().x86_udivmodx(
        Value::from_u32(nlo),
        Value::from_u32(nhi),
        Value::from_u32(d),
    );
...
#[no_mangle]
pub extern "C" fn cranelift_x86_sdivmodx(
    ptr: *mut FunctionData,
    nlo: ValueCode,
    nhi: ValueCode,
    d: ValueCode,
    ...
    let (tmp1, tmp2) = inst.builder.ins().x86_sdivmodx(
        Value::from_u32(nlo),
        Value::from_u32(nhi),
        Value::from_u32(d),
    );
...
#[no_mangle]
pub extern "C" fn cranelift_x86_umulx(
    ptr: *mut FunctionData,
    argl: ValueCode,
    argr: ValueCode,
    res1: &mut ValueCode,
    ...
    let (tmp1, tmp2) = inst
        .builder
        .ins()
        .x86_umulx(Value::from_u32(argl), Value::from_u32(argr));
    *res1 = tmp1.as_u32();
    *res2 = tmp2.as_u32();
}

#[no_mangle]
pub extern "C" fn cranelift_x86_smulx(
    ptr: *mut FunctionData,
    argl: ValueCode,
    argr: ValueCode,
    res1: &mut ValueCode,
    ...
    let (tmp1, tmp2) = inst
        .builder
        .ins()
        .x86_smulx(Value::from_u32(argl), Value::from_u32(argr));
    *res1 = tmp1.as_u32();
    *res2 = tmp2.as_u32();
}

#[no_mangle]
pub extern "C" fn cranelift_x86_cvtt2si(
    ptr: *mut FunctionData,
    intto: Type,
    x: ValueCode,
) -> ValueCode {
    ...
    return inst
        .builder
        .ins()
        .x86_cvtt2si(convert_type(intto), Value::from_u32(x))
        .as_u32();
}

#[no_mangle]
pub extern "C" fn cranelift_x86_fmin(
    ptr: *mut FunctionData,
    x: ValueCode,
    y: ValueCode,
) -> ValueCode {
    ...
    return inst
        .builder
        .ins()
        .x86_fmin(Value::from_u32(x), Value::from_u32(y))
        .as_u32();
}

#[no_mangle]
pub extern "C" fn cranelift_x86_fmax(
    ptr: *mut FunctionData,
    x: ValueCode,
    y: ValueCode,
) -> ValueCode {
    ...
    return inst
        .builder
        .ins()
        .x86_fmax(Value::from_u32(x), Value::from_u32(y))
        .as_u32();
}
...
#[no_mangle]
pub extern "C" fn cranelift_x86_bsr(
    ptr: *mut FunctionData,
    x: ValueCode,
    res1: &mut ValueCode,
    res2: &mut ValueCode,
...
#[no_mangle]
pub extern "C" fn cranelift_x86_bsf(
    ptr: *mut FunctionData,
    x: ValueCode,
    res1: &mut ValueCode,
    res2: &mut ValueCode,
...
#[no_mangle]
pub extern "C" fn cranelift_x86_pshufd(
    ptr: *mut FunctionData,
    a: ValueCode,
    i: Uimm8,
) -> ValueCode {
    ...
    return inst
        .builder
        .ins()
        .x86_pshufd(Value::from_u32(a), i)
        .as_u32();
}

#[no_mangle]
pub extern "C" fn cranelift_x86_pshufb(
    ptr: *mut FunctionData,
    a: ValueCode,
    b: ValueCode,
) -> ValueCode {
    ...
    return inst
        .builder
        .ins()
        .x86_pshufb(Value::from_u32(a), Value::from_u32(b))
        .as_u32();
}

#[no_mangle]
pub extern "C" fn cranelift_x86_pextr(
    ptr: *mut FunctionData,
    x: ValueCode,
    idx: Uimm8,
) -> ValueCode {
    ...
    return inst
        .builder
        .ins()
        .x86_pextr(Value::from_u32(x), idx)
        .as_u32();
}

#[no_mangle]
pub extern "C" fn cranelift_x86_pinsr(
    ptr: *mut FunctionData,
    x: ValueCode,
    y: ValueCode,
    idx: Uimm8,
    ...
    return inst
        .builder
        .ins()
        .x86_pinsr(Value::from_u32(x), Value::from_u32(y), idx)
        .as_u32();
}

#[no_mangle]
pub extern "C" fn cranelift_x86_insertps(
    ptr: *mut FunctionData,
    x: ValueCode,
    y: ValueCode,
    idx: Uimm8,
    ...
    return inst
        .builder
        .ins()
        .x86_insertps(Value::from_u32(x), Value::from_u32(y), idx)
        .as_u32();
}

#[no_mangle]
pub extern "C" fn cranelift_x86_punpckh(
    ptr: *mut FunctionData,
    x: ValueCode,
    y: ValueCode,
) -> ValueCode {
    ...
    return inst
        .builder
        .ins()
        .x86_punpckh(Value::from_u32(x), Value::from_u32(y))
        .as_u32();
}

#[no_mangle]
pub extern "C" fn cranelift_x86_punpckl(
    ptr: *mut FunctionData,
    x: ValueCode,
    y: ValueCode,
) -> ValueCode {
    ...
    return inst
        .builder
        .ins()
        .x86_punpckl(Value::from_u32(x), Value::from_u32(y))
        .as_u32();
}

#[no_mangle]
pub extern "C" fn cranelift_x86_packss(
    ptr: *mut FunctionData,
    x: ValueCode,
    y: ValueCode,
) -> ValueCode {
    ...
    return inst
        .builder
        .ins()
        .x86_packss(Value::from_u32(x), Value::from_u32(y))
        .as_u32();
}

#[no_mangle]
pub extern "C" fn cranelift_x86_movsd(
    ptr: *mut FunctionData,
    x: ValueCode,
    y: ValueCode,
) -> ValueCode {
    ...
    return inst
        .builder
        .ins()
        .x86_movsd(Value::from_u32(x), Value::from_u32(y))
        .as_u32();
}

#[no_mangle]
pub extern "C" fn cranelift_x86_movlhps(
    ptr: *mut FunctionData,
    x: ValueCode,
    y: ValueCode,
) -> ValueCode {
    ...
    return inst
        .builder
        .ins()
        .x86_movlhps(Value::from_u32(x), Value::from_u32(y))
        .as_u32();
}

#[no_mangle]
pub extern "C" fn cranelift_x86_psll(
    ptr: *mut FunctionData,
    x: ValueCode,
    y: ValueCode,
) -> ValueCode {
    ...
    return inst
        .builder
        .ins()
        .x86_psll(Value::from_u32(x), Value::from_u32(y))
        .as_u32();
}

#[no_mangle]
pub extern "C" fn cranelift_x86_psrl(
    ptr: *mut FunctionData,
    x: ValueCode,
    y: ValueCode,
) -> ValueCode {
    ...
    return inst
        .builder
        .ins()
        .x86_psrl(Value::from_u32(x), Value::from_u32(y))
        .as_u32();
}

#[no_mangle]
pub extern "C" fn cranelift_x86_psra(
    ptr: *mut FunctionData,
    x: ValueCode,
    y: ValueCode,
) -> ValueCode {
    ...
    return inst
        .builder
        .ins()
        .x86_psra(Value::from_u32(x), Value::from_u32(y))
        .as_u32();
}

#[no_mangle]
pub extern "C" fn cranelift_x86_ptest(
    ptr: *mut FunctionData,
    x: ValueCode,
    y: ValueCode,
) -> ValueCode {
    ...
    return inst
        .builder
        .ins()
        .x86_ptest(Value::from_u32(x), Value::from_u32(y))
        .as_u32();
}

//#[no_mangle]
//pub extern "C" fn cranelift_x86_pmaxs(
//    ptr: *mut FunctionData,
//    x: ValueCode,
//    y: ValueCode,
//) -> ValueCode {
...
//        .builder
//        .ins()
//        .x86_pmaxs(Value::from_u32(x), Value::from_u32(y))
//        .as_u32();
//}

//#[no_mangle]
//pub extern "C" fn cranelift_x86_pmaxu(
//    ptr: *mut FunctionData,
//    x: ValueCode,
//    y: ValueCode,
//) -> ValueCode {
...
//        .builder
//        .ins()
//        .x86_pmaxu(Value::from_u32(x), Value::from_u32(y))
//        .as_u32();
//}

//#[no_mangle]
//pub extern "C" fn cranelift_x86_pmins(
//    ptr: *mut FunctionData,
//    x: ValueCode,
//    y: ValueCode,
//) -> ValueCode {
...
//        .builder
//        .ins()
//        .x86_pmins(Value::from_u32(x), Value::from_u32(y))
//        .as_u32();
//}

//#[no_mangle]
//pub extern "C" fn cranelift_x86_pminu(
//    ptr: *mut FunctionData,
//    x: ValueCode,
//    y: ValueCode,
//) -> ValueCode {
...
//        .builder
//        .ins()
//        .x86_pminu(Value::from_u32(x), Value::from_u32(y))
//        .as_u32();
//}
//
//#[no_mangle]
//pub extern "C" fn cranelift_x86_elf_tls_get_addr(
//    ptr: *mut FunctionData,
//    gv: GlobalValueCode,
//) -> ValueCode {
//    let inst = unsafe {
...
//        .builder
//        .ins()
//        .x86_elf_tls_get_addr(GlobalValue::from_u32(gv))
//        .as_u32();
//}
//
//#[no_mangle]
